...
- Report vulnerabilities privately through [GitHub Security Advisories](https://github.com/mckay115/aval-design-studio/security/advisories/new).

Please do not attach private source media. Share container, codec, dimensions, frame rate, duration, transparency mode, and a minimal synthetic reproduction when possible.
